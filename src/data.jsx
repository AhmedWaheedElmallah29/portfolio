import { Code2, Zap, Globe as GlobeIcon, Users, ShoppingCart, Droplets, Award, BookOpen, GraduationCap } from 'lucide-react';
import {
  SiHtml5, SiCss, SiJavascript, SiReact, SiVite,
  SiReactrouter, SiTailwindcss, SiSass, SiBootstrap,
  SiAxios, SiExpress, SiMongodb, SiGit, SiGithub,
  SiNetlify, SiVercel, SiNotion
} from 'react-icons/si';

export const personalInfo = {
  name: "Ahmed Elmallah",
  title: "Frontend Developer",
  tagline: "Building responsive, scalable web apps with React.js and modern frontend tech. Passionate about clean code and intuitive user experiences.",
  ...
  website: "https://elmallah-portfolio.netlify.app"
};

export const aboutStrengths = [
  { icon: <Code2 size={20} />, text: 'React.js, Vite & component-based architecture' },
  { icon: <Zap size={20} />, text: 'State management with Context API' },
  { icon: <GlobeIcon size={20} />, text: 'REST API integration & authentication (Clerk)' },
...
export const projects = [
  {
    ...
    tech: ['React', 'Vite', 'Mantine UI', 'Context API', 'Formik', 'Yup', 'Axios'],
    liveUrl: 'https://e-commerce-tau-one-84.vercel.app/',
