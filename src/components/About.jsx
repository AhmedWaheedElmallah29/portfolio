        ...
        <div className="about-grid">
          ...
          <div className="about-text reveal">
            <p className="about-lead">
              ...
              complete, production-grade web applications — not just frontend
              interfaces, but full systems with authentication, databases,
              real-time features, and admin dashboards.
            </p>
            <p>
              ...
              <span className="code-inline">Supabase</span>. I've shipped
              projects ranging from a full e-commerce platform with an internal
              admin dashboard, to a real-time chat &amp; video calling app
              integrated with third-party SDKs.
            </p>
            <p>
              I also served as a{" "}
              <span className="highlight">Frontend Instructor at IEEE</span>,
              teaching HTML, CSS, JavaScript, and React — which sharpened both
              my technical depth and my ability to communicate complex ideas
              clearly.
            </p>
